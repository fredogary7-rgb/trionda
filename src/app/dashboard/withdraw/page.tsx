  ...
  const fetchData = () => {
    ...
    fetch("/api/dashboard")
      ...
      .then(d => {
        ...
        setHasActiveInvest(
          d.investments?.some((i: any) => i.status === "active") ?? false
        );
      })
      ...
      <div className="card p-5">
        ...
        {!hasActiveInvest ? (
          <div className="text-center py-4">
            ...
            <p className="text-sm font-semibold text-flame-300 mb-1">
              Aucun investissement actif
            </p>

            <p className="text-xs text-gray-400 mb-4">
              Vous devez avoir un investissement en cours pour retirer.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="input-light py-2.5 text-sm"
                placeholder="Nom sur le compte Orange"
              />
            </div>

            <div className="flex items-start gap-2 p-3 bg-flame-500/5 border border-flame-500/10 rounded-xl">
              <span className="text-flame-400 text-sm shrink-0">
                ⚠️
              </span>

              <p className="text-[11px] text-flame-300">
                Vérifiez le numéro et le montant. Traitement sous 24-48h.
              </p>
            </div>
