...
export default function ContactButtons() {
  return (
    <div className="card card-padded mb-4">
      <p className="text-sm font-bold text-gray-900 mb-4">Nous contacter</p>
      <p className="text-xs text-gray-400 mb-4">Besoin d&apos;aide ? Contactez notre équipe.</p>
      ...
      <div className="space-y-3">
        ...
        <a
          ...
          className="flex items-center gap-3 p-3 rounded-2xl bg-sky-50 border border-sky-100 hover:bg-sky-100 transition-colors group"
        >
          <div className="w-10 h-10 rounded-xl bg-sky-500 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-sky-500 truncate">@trionda_service01</p>
          </div>
          <svg className="w-4 h-4 text-sky-400 group-hover:translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-emerald-500 truncate">Rejoindre le groupe</p>
          </div>
          <svg className="w-4 h-4 text-emerald-400 group-hover:translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
          </svg>
        </a>
      </div>
