      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            {isAdmin && (
              <Link href="/admin" className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-flame-500/10 border border-flame-500/20 text-xs font-medium text-flame-400 hover:bg-flame-500/20 transition-colors">
